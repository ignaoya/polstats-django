# Generated by Django 3.2 on 2021-08-09 10:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='source_articles', to='main_app.source')),
            ],
            options={
                'ordering': ('-date',),
            },
